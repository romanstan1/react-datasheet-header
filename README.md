### This package has been copied and edited from Nadbm's https://nadbm.github.io/ react-datasheet version 1.2.12.

#### It creates a 'thead' element from the FIRST object in the array passed to the 'data' property on the component. You can then use CSS upon the thead and tbody elements to create a fixed header on scroll. (eg 'overflow:auto' on tbody.)  
